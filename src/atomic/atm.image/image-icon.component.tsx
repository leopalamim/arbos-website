...
import icInstagramColored from 'assets/img/ic-instagram-colored.png'
import icLinkedin from 'assets/img/ic-linkedin.png'
import icLinkedinColored from 'assets/img/ic-linkedin-colored.png'
...
export const ImageIcon = {
  ...
  InstagramColored: () => <Image priority={true} src={icInstagramColored} alt={'Instagram icon'} width={'40px'} height={'40px'} />,
  Linkedin: () => <Image priority={true} src={icLinkedin} alt={'Linkedin icon'} width={'40px'} height={'40px'} />,
  LinkedinColored: () => <Image priority={true} src={icLinkedinColored} alt={'Linkedin icon'} width={'40px'} height={'40px'} />,
